...
const HomeExplore: React.FC = () => {
  ...
  const switchStory = (activeStory: number) => {
    ...
    stories.forEach((story, index) => {
      if (activeStory === index) {
        ...
        newArr[index] = {
          ...story,
          transform: `rotate(-8deg) scale(0.9) translateX(-${
            (index + 1) * 100
          }%)`,
        };
      }
  ...
  return (
    <Container>
      <Heading>
        It’s really easy to not remember what you are grateful for...
      </Heading>
      <ImgWrap>
      ...
      <Text>
        did you meet someone special or some set of people that switched things
        up for good this year?
      </Text>
