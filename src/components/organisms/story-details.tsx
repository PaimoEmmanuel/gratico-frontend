...
const StoryDetails: React.FC<StoryDetailsProps> = ({ onSubmit, title, setTitle, content, setContent }) => {
	...
	return (
		<Form>
			<Email>
				...
				/>
				<InputNote>E.g. Keep believing!. Dilligence pays etc.</InputNote>
			</Email>
			<Name>
				<Label htmlFor=''>This is the body of your story</Label>
				{/* <Editor
        ...
        /> */}
				...
				<InputNote>
					<InputNote>Don’t leave out the juices, we are here for all of it!</InputNote>
				</InputNote>
				<Button
